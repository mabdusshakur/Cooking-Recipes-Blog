...
@section('content')
    ...
    <script>
        ...
        const setRecipe = async () => {
            let res = await axios.get(`/api/v1/author/recipes/${id}`);
            res = res.data[0];
            console.log(res);
            document.getElementById('title').value = res.title;
            document.getElementById('prepare_time').value = res.prepare_time;
            document.getElementById('difficulty').value = res.difficulty;
            document.getElementById('serving').value = res.serving;
            document.getElementById('recipe-short-description').value = res.short_description;
            document.getElementById('snow-editor').innerHTML = res.long_description;
            document.getElementById('category').value = res.category.id;
            ...
            res.NutritionalValues.forEach((nutritionalValue, index) => {
                ...
                nameInput.value = nutritionalValue.name;
                ...
                amountInput.value = nutritionalValue.amount;
                ...
                calorieInput.value = nutritionalValue.calorie_per_gram;
                ...
                document.getElementById('add-nutritional-value').parentNode.insertBefore(row, document.getElementById('add-nutritional-value'));
            });
        }
