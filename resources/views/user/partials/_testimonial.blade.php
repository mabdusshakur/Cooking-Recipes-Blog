<section class="testimonial padding-tb" style="background-image: url(user/assets/css/bg-image/category-bg.jpg); background-size: cover;">
     <div class="container">
          <div class="section-wrapper">
               <div class="quete-thumb">
                    <img src="{{ asset('user/assets/images/testimonial/icon/01.jpg')}}" alt="food-quete">
               </div>
               <div id="demo" class="carousel slide vert">
                    ...
                    <div class="carousel-indicators">
                         <div data-bs-target="#demo" data-bs-slide-to="0" class="item active">
                              <img src="{{ asset('user/assets/images/testimonial/01.jpg')}}" alt="">
                         </div>
                         <div data-bs-target="#demo" data-bs-slide-to="1" class="item">
                              <img src="{{ asset('user/assets/images/testimonial/02.jpg')}}" alt="">
                         </div>
                         <div data-bs-target="#demo" data-bs-slide-to="2" class="item">
                              <img src="{{ asset('user/assets/images/testimonial/03.jpg')}}" alt="">
                         </div>
                    </div>
               </div>
          </div>
