               ...
               <div class="row justify-content-center">
                    ...
                    <div class="col-xl-4 col-md-6 col-12">
                         <div class="chef-item">
                              <div class="chef-inner">
                                   <div class="chef-thumb">
                                        <img src="{{ asset('user/assets/images/chef/02.jpg')}}" alt="food-chef">
                                   </div>
                                   <div class="chef-content">
                                        <div class="chef-author">
                                             <a href="#">
                                                  <img src="{{ asset('user/assets/images/chef/author/08.jpg')}}" alt="chef-author">
                                             </a>
                                        </div>
                    ...
                    <div class="col-xl-4 col-md-6 col-12">
                         <div class="chef-item">
                              <div class="chef-inner">
                                   <div class="chef-thumb">
                                        <img src="{{ asset('user/assets/images/chef/03.jpg')}}" alt="food-chef">
                                   </div>
                                   <div class="chef-content">
                                        <div class="chef-author">
                                             <a href="#">
                                                  <img src="{{ asset('user/assets/images/chef/author/09.jpg')}}" alt="chef-author">
                                             </a>
                                        </div>
